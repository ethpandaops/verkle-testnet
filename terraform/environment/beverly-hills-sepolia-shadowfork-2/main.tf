...
terraform {
  backend "s3" {
    ...
    region                      = "us-east-1"
    bucket                      = "verkle"
    key                         = "infrastructure/beverly-hills-shadowfork-2/terraform.tfstate"
  }
}
////////////////////////////////////////////////////////////////////////////////////////
//                                        VARIABLES
...
variable "ethereum_network" {
  type = string
  default = "beverly-hills-sepolia-shadowfork-2"
}
  ...
  default = [
    {
      ...
      vms = {
        ...
        "2"        = {}
        "3"        = {}
        "bootnode" = { tags = "bootnode,tooling", size = "s-8vcpu-16gb-amd" }
      },
    },
      {
      id  = "lighthouse-geth"
      vms = {
        ...
        "2"        = {}
        "3"        = {}
        "bootnode" = { tags = "bootnode", size = "s-8vcpu-16gb-amd" }
      },
    },
  ]
}
