...
prep_group 1 "$VALIDATORS_MNEMONIC_0" 0 8 "beverly-hills-teku-geth" 16
prep_group 1 "$VALIDATORS_MNEMONIC_0" 8 6 "beverly-hills-lighthouse-geth" 16
prep_group 1 "$VALIDATORS_MNEMONIC_0" 14 6 "beverly-hills-lodestar-geth" 16