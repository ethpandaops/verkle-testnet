...
prep_group 1 "$VALIDATORS_MNEMONIC_0" 0 6 "beverly-hills-sepolia-shadowfork-1-lighthouse-geth" 64
prep_group 1 "$VALIDATORS_MNEMONIC_0" 6 6 "beverly-hills-sepolia-shadowfork-1-lodestar-geth" 64
prep_group 1 "$VALIDATORS_MNEMONIC_0" 12 8 "beverly-hills-sepolia-shadowfork-1-teku-geth" 64
