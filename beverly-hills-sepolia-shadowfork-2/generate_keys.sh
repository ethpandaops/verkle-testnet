...
prep_group 1 "$VALIDATORS_MNEMONIC_0" 0 3 "beverly-hills-sepolia-shadowfork-2-lighthouse-geth" 64
prep_group 1 "$VALIDATORS_MNEMONIC_0" 3 3 "beverly-hills-sepolia-shadowfork-2-teku-geth" 64
